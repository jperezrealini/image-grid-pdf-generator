			...
			for (let page = 0; page < numPages; page++) {
				...
				for (let row = 0; row < verticalCount; row++) {
					for (let col = 0; col < horizontalCount; col++) {
						...
						// Draw image in cell (with padding)
						...
						const cellAspectRatio = imageWidth / imageHeight;
						...
						if (imgAspectRatio > cellAspectRatio) {
							...
							finalY = imageY + (imageHeight - finalHeight) / 2;
						} else {
							// Image is taller - fit to height
							finalWidth = imageHeight * imgAspectRatio;
							finalX = imageX + (imageWidth - finalWidth) / 2;
						}
